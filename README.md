# Mini Aladdin — Finance Quant Options  
...
**Mini Aladdin is different.** It isn’t just a one-off predictor — it is a **coherent pipeline** that ties together:  
...
This makes Mini Aladdin a **scaled-down but true reflection** of the “research spine” of BlackRock’s Aladdin.

---

## Mini Aladdin vs. BlackRock’s Aladdin

| **Aspect** | **BlackRock Aladdin** | **Mini Aladdin (this project)** |
|------------|-----------------------|--------------------------------|
...
- **Mini Aladdin = research lab**: open, transparent system that shows how the same math (returns, volatility, covariance, optimization) actually works in practice.  
...
This repository documents the implementation in `MINI_ALADDIN.ipynb` / `mini_aladdin.py`.  
